...
| `tab-outside-tablist`            | A `tab` with no `tablist` ancestor.                                                                                                                                                                                                                                                                                                                                    | 1.3.1     |
| `menuitem-outside-menu`          | A `menuitem`, `menuitemcheckbox` or `menuitemradio` with no `menu` or `menubar` ancestor.                                                                                                                                                                                                                                                                              | 1.3.1     |
| `option-outside-listbox`         | An `option` with no `listbox`, `<select>` or `<datalist>` ancestor.                                                                                                                                                                                                                                                                                                    | 1.3.1     |
